...
# Menu
print("~---------------------~")
print("| " + Lista1.getCampeones()[0].getNombre() + " | " + Lista1.getCampeones()[1].getNombre() + " | " +
      Lista1.getCampeones()[2].getNombre() + " | ")
print("~---------------------~")
...
while p1.getHp() > 0 and p2.getHp() > 0:
    ...
    if p2.getHabilidades()[habilidadp2].getStun() == 0:
        ...
        for h in p1.getHabilidades():
            print (str(x) + " " + h.getSkillname() + " /Damage: " + str(h.getDamage()) + " /Health: " + str(
                h.getHealth()) + " /Shield: " + str(h.getShield()))
            x = x + 1
